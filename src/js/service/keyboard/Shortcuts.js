(function () {
  ...
  ns.Shortcuts = {
    ...
    TOOL : {
      ...
      FILLED_RECTANGLE : createShortcut('tool-filled-rectangle', 'Filled Rectangle tool', 'ctrl+shift+R'),
      CIRCLE : createShortcut('tool-circle', 'Circle tool', 'C'),
      FILLED_CIRCLE : createShortcut('tool-filled-circle', 'Filled Circle tool', 'ctrl+shift+C'),
